...
export default function MetricsPanel() {
  const metrics = {
    monitoreoTotal: '124.5 m',
    bloqueoTiempo: '18.2 m',
    capacidadReducida: '22.5 %',
    saturacion: 38.5,
  };
    ...
    <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 shadow-xl flex flex-col justify-between backdrop-blur-sm hover:border-slate-700 transition">
      <div>
        ...
        <div className="space-y-3 font-mono text-xs">
          <div className="flex justify-between py-2 border-b border-slate-800/60 items-center">
            ...
            <span className="text-slate-200 font-bold">{metrics.monitoreoTotal}</span>
          </div>
          ...
          <div className="flex justify-between py-2 border-b border-slate-800/60 items-center">
            ...
            <span className="text-amber-400 font-bold">{metrics.bloqueoTiempo}</span>
          </div>
          ...
          <div className="flex justify-between py-2 border-b border-slate-800/60 items-center">
            ...
            <span className="text-red-400 font-bold">{metrics.capacidadReducida}</span>
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 pt-4 border-t border-slate-800/80">
        <div className="flex justify-between text-xs font-mono mb-2">
          ...
          <span className="text-blue-400 font-bold">{metrics.saturacion}%</span>
        </div>
        <div className="w-full bg-slate-950 h-3 rounded-full overflow-hidden p-0.5 border border-slate-800">
          <div 
            ...
            style={{ width: `${metrics.saturacion}%` }}
          ></div>
        </div>
      </div>
    </div>
