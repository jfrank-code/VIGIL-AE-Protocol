...
from services.vision_services import (
    model, NOMBRES_CLASES, POLIGONO_A_PORCENTUAL, POLIGONO_B_PORCENTUAL, simular_lpr_peruano
)
...
from blockchain_service import registrar_en_blockchain_auto, cambiar_estado_en_blockchain
import anpr_service
...
def chat_endpoint(req: ChatRequest):
    ...
    if placa_detectada and quiere_crear:
        ...
        reply = (
            ...
            f"El expediente ha sido publicado en la red inmutable."
        )
        return {"reply": reply}
    ...
    if placa_detectada and not quiere_crear:
        ...
        if multas_encontradas:
            ...
            return {"reply": f"🔍 No se registran infracciones para la placa **{placa_detectada}**."}
